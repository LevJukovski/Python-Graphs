...
for ticker in tickers:
    # Update the start date to be yesterday (today is 2023,11,25)
    df = web.DataReader(ticker, "stooq", "2023, 11, 24", dt.datetime.now())
    price = df[-1:]["Close"][0]
    prices.append(price)
...
ax.set_title("Lev's portfolio visualizer", color="#EF6C35", fontsize=20)
